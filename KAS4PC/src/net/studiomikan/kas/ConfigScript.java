...
public class ConfigScript
{
	...
	public boolean History_config(History h)
	{
		...
		// ◆ フォント
		if((value = dic.getDicValue("fontFace")) != null && value.cast(MOKA_VALUE_TYPE.STRING))
			h.setFontFace(value.stringValue());

		// ◆ フォントサイズ
		if((value = dic.getDicValue("fontSize")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.fontSize = (int)value.intValue;

		if((value = dic.getDicValue("messageLineMax")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.messageLineMax = (int)value.intValue;
		...
		// ◆ 閉じるボタンの設定
		if((value = dic.getDicValue("closeFilename")) != null && value.cast(MOKA_VALUE_TYPE.STRING))
			h.closeFilename = value.stringValue();
		if((value = dic.getDicValue("closeWidth")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.closeWidth = (int)value.intValue;
		if((value = dic.getDicValue("closeHeight")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.closeHeight = (int)value.intValue;
		if((value = dic.getDicValue("closeLeft")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.closeLeft = (int)value.intValue;
		if((value = dic.getDicValue("closeTop")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.closeTop = (int)value.intValue;

		// ◆ 前のページボタンの設定
		if((value = dic.getDicValue("prevFilename")) != null && value.cast(MOKA_VALUE_TYPE.STRING))
			h.prevFilename = value.stringValue();
		if((value = dic.getDicValue("prevPageWidth")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.prevPageWidth = (int)value.intValue;
		if((value = dic.getDicValue("prevPageHeight")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.prevPageHeight = (int)value.intValue;
		if((value = dic.getDicValue("prevPageLeft")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.prevPageLeft = (int)value.intValue;
		if((value = dic.getDicValue("prevPageTop")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.prevPageTop = (int)value.intValue;

		// ◆ 次のページボタンの位置
		if((value = dic.getDicValue("nextFilename")) != null && value.cast(MOKA_VALUE_TYPE.STRING))
			h.nextFilename = value.stringValue();
		if((value = dic.getDicValue("nextPageWidth")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.nextPageWidth = (int)value.intValue;
		if((value = dic.getDicValue("nextPageHeight")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.nextPageHeight = (int)value.intValue;
		if((value = dic.getDicValue("nextPageLeft")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.nextPageLeft = (int)value.intValue;
		if((value = dic.getDicValue("nextPageTop")) != null && value.cast(MOKA_VALUE_TYPE.INTEGER))
			h.nextPageTop = (int)value.intValue;
